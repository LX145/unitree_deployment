...
REGISTER_OBSERVATION(velocity_commands)
{
    ...
    auto map_axis_zero_center = [](float v, float mn, float mx) {
    ...
    obs[0] = map_axis_zero_center(joystick->ly(), cfg["lin_vel_x"][0].as<float>(), cfg["lin_vel_x"][1].as<float>());
    obs[1] = map_axis_zero_center(-joystick->lx(), cfg["lin_vel_y"][0].as<float>(), cfg["lin_vel_y"][1].as<float>());
    obs[2] = map_axis_zero_center(-joystick->rx(), cfg["ang_vel_z"][0].as<float>(), cfg["ang_vel_z"][1].as<float>());
